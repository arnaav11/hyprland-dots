...
if choice in ['i', 'install']:
    ...
    time.sleep(0.3)    
    subprocess.run('yay -Syu --needed kitty firefox nemo gpu-screen-recorder-gtk gpu-screen-recorder anyrun-git swayosd swaync playerctl waybar hyprpaper hyprlock hyprpicker grim slurp swappy wlogout qt5ct qt6ct nwg-look nwg-displays kvantum starship thefuck pokemon-colorscripts-git fish uwsm ttf-cascadia-code-nerd ttf-jetbrains-mono-nerd cantarell-fonts'.split())
